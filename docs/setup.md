...
- [Setup Guide](#setup-guide)
  ...
  - [System Requirements](#system-requirements)
    - [Required API Keys Per Tool](#required-api-keys-per-tool)
  ...
  - [Running Benchmarks](#running-benchmarks)
    ...
    - [Run Specific Adapters](#run-specific-adapters)
    - [Run with Options](#run-with-options)
    - [View Results](#view-results)
  - [Token Usage Tracking](#token-usage-tracking)
    - [Install ccusage](#install-ccusage)
    - [Track Usage](#track-usage)
    - [Cost Estimation](#cost-estimation)
  - [Environment Variables Reference](#environment-variables-reference)
    - [Quick Reference Table](#quick-reference-table)
    - [Minimal Setup (No API Keys)](#minimal-setup-no-api-keys)
    - [Full `.env` Template](#full-env-template)
  - [Troubleshooting](#troubleshooting)
    - [Common Issues](#common-issues)
      - ["Playwright browsers not found"](#playwright-browsers-not-found)
      - ["Missing API key" (browser-use / stagehand)](#missing-api-key-browser-use--stagehand)
      - ["Chrome extension not detected" (claude-code-chrome)](#chrome-extension-not-detected-claude-code-chrome)
      - ["Playwriter: No connection to extension"](#playwriter-no-connection-to-extension)
      - ["Firecrawl: 401 Unauthorized"](#firecrawl-401-unauthorized)
      - ["browser-use: Module not found"](#browser-use-module-not-found)
      - ["Stagehand: No LLM response"](#stagehand-no-llm-response)
      - ["Browserbase: Session creation failed"](#browserbase-session-creation-failed)
